...
local config = {
  ...
  settings = {
    java = {
      -- Replace this with the absolute path to your main java version (JDTLS requires JDK 21 or higher)
      home = home .. '/.sdkman/candidates/java/21.0.4-amzn',
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = 'JavaSE-1.8',
            path = home .. '/.sdkman/candidates/java/8.0.462-amzn',
          },
          {
            name = 'JavaSE-21',
